...
async function myAnalysis(context, scope) {
  ...
  context.log(`base64 data is ${data}`);
    ...
    var adress = parseInt(data.slice(0, 2));
    context.log('adress', adress);
    var pulses = data.slice(2, 6);
    context.log('pulses', pulses);
    var pulses_hour = parseInt(data.slice(6, 14), 16);
    context.log('pulsos hora', pulses_hour);
